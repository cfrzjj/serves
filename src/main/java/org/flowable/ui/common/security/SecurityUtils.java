...
public class SecurityUtils {
    ...
    public static SecurityScope getSecurityScope(Authentication authentication) {
        //添加 通过增加 SimpleGrantedAuthority 添加应用程序
        List<GrantedAuthority> grantedAuthorityList= new ArrayList<>();
//        grantedAuthorityList.add(new SimpleGrantedAuthority("access-admin"));
//        grantedAuthorityList.add(new SimpleGrantedAuthority("access-idm"));
        grantedAuthorityList.add(new SimpleGrantedAuthority("access-modeler"));
//        grantedAuthorityList.add(new SimpleGrantedAuthority("access-rest-api"));
//        grantedAuthorityList.add(new SimpleGrantedAuthority("access-task"));

        User user = new User("admin","",grantedAuthorityList);
        RememberMeAuthenticationToken key = new RememberMeAuthenticationToken("key", user, grantedAuthorityList);
        key.setDetails(authentication.getDetails());
        authentication = key;
